 ...
 */
@Service
public class SaveDeployRecordService extends ServiceImpl<DeployRecordMapper, TfDeployRecord> {

    private static final Logger logger = LoggerFactory.getLogger(SaveDeployRecordService.class);
    ...
    public String saveDeployRecord(String systemId, String testStage, String sendTestInfo,
        ...
        logger.info("发版登记保存成功: systemId={}, testStage={}, versionCode={}",
