package com.king.configuration.merge.mapper;
 ...
 */
@Mapper
public interface MergeRecordMapper extends BaseMapper<TfDeployRecord> {
     ...
     * 分页查询发版登记列表（带系统名称）
     * @param page 分页对象
     * @param queryCondition 查询条件：all-全部，related-和我相关
     * @param userId 当前用户ID（当 queryCondition=related 时需要）
